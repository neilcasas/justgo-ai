...
import { Star, MapPin, Clock, Award, Phone, Mail, Calendar, CheckCircle, Building } from "lucide-react"
...
const lawyerProfiles = {
  ...
  "2": {
    ...
    email: "juan.reyes@pao.gov.ph",
    description:
      "Atty. Juan Reyes is a seasoned criminal defense attorney with 15 years of experience in Philippine criminal law. He provides free legal services through the Public Attorney's Office and has successfully defended clients in high-profile cases with extensive experience in drug cases, theft, and white-collar crimes.",
    education: [
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mb-4">
                      ...
                      <div className="flex items-center text-sm text-gray-600">
                        ...
                        <span
                          className={`font-medium ${lawyerProfile.rate === "Free" ? "text-green-600" : "text-blue-600"}`}
                        >
                          {lawyerProfile.rate}
                        </span>
                      </div>
                      ...
                      <div className="flex items-center text-sm text-gray-600 md:col-span-2">
                        ...
                        <span>{lawyerProfile.organization}</span>
                      </div>
                    </div>
              ...
              <CardContent className="space-y-4">
                {lawyerProfile.clientReviews.map((review, index) => (
                  <div key={index}>
                    ...
                    {index < lawyerProfile.clientReviews.length - 1 && <Separator className="mt-4" />}
                  </div>
                ))}
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm">{lawyerProfile.organization}</span>
                </div>
              </CardContent>
            </Card>
