...
const mockChatHistory: ChatHistory[] = [
  ...
  },
  {
    ...
    date: "2 weeks ago",
    preview: "What are the legal requirements for starting a business in the Philipp...",
  },
  {
    id: "7",
    title: "Insurance Claim Denial",
    date: "3 weeks ago",
    preview: "My health insurance claim was denied and I need to appeal the decision...",
  },
  {
    id: "8",
    title: "Animal Abuse Laws",
    date: "1 month ago",
    preview: "What laws pertain to animal abuse in the Philippines and how can I report...",
  },
]
        ...
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription className="text-base">
              Welcome to JustGo AI. Your privacy and data security are our top priorities.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-4 space-y-4">
            <div className="flex items-start space-x-3 p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <div>
                <h4 className="font-semibold text-green-900 mb-1">End-to-End Encryption</h4>
                <p className="text-sm text-green-800">
                  All your conversations are protected with end-to-end encryption. Only you can access your chat history
            ...
            <div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div>
                <h4 className="font-semibold text-blue-900 mb-1">Data Privacy Act Compliance</h4>
                <p className="text-sm text-blue-800">
                  JustGo fully complies with the{" "}
                  <a
                  ...
                  . Your personal information is handled with the highest standards of data protection.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-4 bg-amber-50 rounded-lg border border-amber-200">
              ...
              <div>
                <h4 className="font-semibold text-amber-900 mb-1">Document Security</h4>
                <p className="text-sm text-amber-800">
                  Documents you upload are processed securely and are <strong>not permanently saved</strong> on our
                  servers. They are automatically deleted after processing to ensure your confidentiality.
                </p>
              </div>
            </div>
            ...
            <div className="text-xs text-gray-600 bg-gray-50 p-3 rounded-lg">
              <p className="mb-2">
                <strong>What we collect:</strong> Only the information necessary to provide legal assistance (chat
                messages, uploaded documents for processing).
              </p>
              <p className="mb-2">
                <strong>What we don't do:</strong> We don't sell your data, share it with third parties for marketing,
                or use it for purposes other than providing legal services.
              </p>
              <p>
          ...
          <DialogFooter>
            <Button onClick={closePrivacyModal} className="w-full">
