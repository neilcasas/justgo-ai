...
import { Send, FileText, Download, User, Bot, Loader2, Upload, X, File } from "lucide-react"
                  ...
                  {message.type === "ai" && (
                    <div className="mt-4 p-3 bg-red-50 rounded-lg border border-red-200">
                      <p className="text-xs text-red-700">
                        ...
                        advice. This information is for educational purposes only and should not be considered as legal
                        counsel. Please consult with a qualified attorney before making any legal decisions or taking
                        action based on this advice.
                      </p>
                    </div>
                  )}
                </div>
          ...
          <CardContent className="p-4">
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              ...
              <Badge
                variant="secondary"
                className="cursor-pointer text-xs"
                onClick={() => setInput("What are the legal requirements for starting a business in the Philippines?")}
              >
                Starting a Business
              </Badge>
              <Badge
