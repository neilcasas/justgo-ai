        ...
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription className="text-base">
              Welcome to JustGo AI. Your privacy and data security are our top
              priorities.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-4 space-y-4">
            <div className="flex items-start space-x-3 p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <div>
                ...
                <p className="text-sm text-green-800">
                  All your conversations are protected with end-to-end
                  encryption. Only you can access your chat history and legal
                  consultations.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800">
                  ...
                  . Your personal information is anonymized when uploaded and is
                  handled with the highest standards of data protection.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-4 bg-amber-50 rounded-lg border border-amber-200">
              ...
              <div>
                ...
                <p className="text-sm text-amber-800">
                  Documents you upload are processed securely and are{" "}
                  <strong>not permanently saved</strong> on our servers. They
                  are automatically deleted after processing to ensure your
                  confidentiality.
                </p>
              </div>
            </div>
            ...
            <div className="text-xs text-gray-600 bg-gray-50 p-3 rounded-lg">
              <p className="mb-2">
                <strong>What we collect:</strong> Only the information necessary
                to provide legal assistance (chat messages, uploaded documents
                for processing).
              </p>
              <p className="mb-2">
                <strong>What we don't do:</strong> We don't sell your personal
                data, share it with third parties for marketing, or use it for
                purposes other than providing legal services.
              </p>
              <p>
